...
# def test_grid_flex_2d(straight_factory: Callable[..., kf.KCell]) -> None:
#     c = kf.KCell()
...
# def test_grid_flex_2d_shape(straight_factory: Callable[..., kf.KCell]) -> None:
#     c = kf.KCell()
...
# def test_grid_flex_2d_shape_toosmall(straight_factory: Callable[..., kf.KCell]) -> None:
#     with pytest.raises(ValueError):
#         c = kf.KCell()
