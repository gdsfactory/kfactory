...
from .exceptions import MergeError, MutableDefaultArgumentError
from .kcell import (
    AnyTKCell,
    BaseKCell,
    DKCell,
        ...
        *,
        ...
        def decorator_autocell(
            ...
            mutable_params = [
                ...
                if _is_mutable_default(p.default)
            ]
            if mutable_params:
                raise MutableDefaultArgumentError(f.__name__, mutable_params)
