...
Most gdsfactory functions take some inputs and return a KCell object.
...
- KCellFactory: function that returns a KCell.
- RouteFactory: function that returns a Route.


Specs:

- KCellSpec: KCell, function, string or dict
...
from kfactory.cross_section import CrossSection as CrossSection
from kfactory.cross_section import Section as Section

# from kfactory.layers import LayerColor, LayerColors
from kfactory.kcell import Instance as Instance
from kfactory.kcell import KCell as KCell
from kfactory.kcell import Port
from kfactory.kdb import Text
from kfactory.tech import LayerLevel, LayerStack
...
KCellFactory = Callable[..., KCell]
KCellFactoryDict = Dict[str, KCellFactory]
PathType = Union[str, pathlib.Path]
PathTypes = Tuple[PathType, ...]

KCellOrPath = Union[PathType, KCell]
KCellOrReference = Union[KCell, Instance]
NameToFunctionDict = Dict[str, KCellFactory]
Number = Union[float, int]
Coordinate = Tuple[float, float]
Coordinates = Tuple[Coordinate, ...]
# KCellOrPath = Union[KCell, PathType]
...
KCellSpec = Union[str, KCellFactory, KCell, Dict[str, Any]]
"""Description capable of generating a component. Can be a PCell function, function name, dict or KCell."""

KCellSpecOrList = Union[KCellSpec, List[KCellSpec]]
CellSpec = Union[str, KCellFactory, Dict[str, Any]]
"""Description capable of generating a cell function. Can be a PCell function, function name or dict."""

KCellSpecDict = Dict[str, KCellSpec]
...
class NetlistModel(BaseModel):
    ...
    instances: Optional[Dict[str, KCellModel]] = None
