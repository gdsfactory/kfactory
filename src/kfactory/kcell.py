...
class ProtoTKCell(ProtoKCell[TUnit], ABC):
    ...
    def create_inst(
        ...
        a: tuple[TUnit, TUnit] | None = None,
        b: tuple[TUnit, TUnit] | None = None,
        na: int = 1,
        nb: int = 1,
    ...
    def create_inst(
        ...
        return DInstance(
            ...
            instance=self._create_inst(
                cell,
                trans or kdb.Trans(),
                kdb.DVector(*a).to_itype(self.kcl.dbu) if a else None,
                kdb.DVector(*b).to_itype(self.kcl.dbu) if b else None,
                na,
                nb,
                libcell_as_static,
    ...
    def create_inst(
        ...
        return Instance(
            ...
            instance=self._create_inst(
                cell,
                trans or kdb.Trans(),
                kdb.Vector(*a) if a else None,
                kdb.Vector(*b) if b else None,
                na,
                nb,
                libcell_as_static,
                static_name_separator,
