...
def rectangles(
    ...
    for i in range(n):
        ...
        if v:
            wg_v = wg_f(v)
            wg1 = c << wg_v
            wg1.transport("o1", b1, "o2")
            b2.transport("o1", wg1, "o2")
        else:
            b2.transport("o1", b1, "o2")
        _l_straight = l_straight + 2 * i * pitch
        if _l_straight:
            wg_h = wg_f(_l_straight)
            wg2 = c << wg_h
            wg2.transport("o1", b2, "o2")
            b3.transport("o1", wg2, "o2")
        else:
            b3.transport("o1", b2, "o2")
        if v:
            wg3 = c << wg_v
            wg3.transport("o1", b3, "o2")
            b4.transport("o1", wg3, "o2")
        else:
            b4.transport("o1", b3, "o2")
        if _l_straight:
            wg4 = c << wg_h
            wg4.transport("o1", b4, "o2")
